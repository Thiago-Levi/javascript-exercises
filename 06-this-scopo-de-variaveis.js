...
*/
const myName = 'Thiago Levi Ramos da Costa'
/*
  02
...
//console.log(`Valor de let é = ${age}`)
//myAge()
...
const car = {
  name: 'my car name',
  brand: 'my brand car',
  color: ['first Color', 'Second Color', 'Trird Color'],
  isRunning: false,
  run (){
    this.isRunning = true
  ...
  stop (){
    ...
    return console.log(`${this.name} está parado`)
  },
  getColorsMessage(){
...
*/
console.log(`As cores do caro são: ${car.color.slice(0, 2).join(', ')} e ${car.color.slice(2)}.`)
